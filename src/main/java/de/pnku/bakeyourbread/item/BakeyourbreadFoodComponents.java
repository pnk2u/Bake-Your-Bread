...
public class BakeyourbreadFoodComponents {
    ...
    public static final FoodProperties COOKED_CARROT_F = (new FoodProperties.Builder()).nutrition(3).saturationModifier(0.6F).build();
    public static final FoodProperties UNCOOKED_GOLDEN_CARROT_F = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.2F).build();
